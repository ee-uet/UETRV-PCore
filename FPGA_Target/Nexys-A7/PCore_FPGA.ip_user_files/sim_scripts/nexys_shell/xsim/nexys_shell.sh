...
xv_boost_lib_path=/home/mtahir/Xilinx/Vivado/2019.1/tps/boost_1_64_0
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconstant_v1_1_6 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L smartconnect_v1_0 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot nexys_shell xil_defaultlib.nexys_shell xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim nexys_shell -key {Behavioral:sim_1:Functional:nexys_shell} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4cab.protoinst" -protoinst "protoinst_files/nexys_shell.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/mtahir/Xilinx/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb nexys_shell.wdb xsim.dir)
