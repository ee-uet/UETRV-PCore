...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.nexys_shell \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../PCore_FPGA.srcs/sources_1/bd/nexys_shell/ipshared/1ddd/hdl/verilog" \
       +incdir+"$ref_dir/../../../../PCore_FPGA.srcs/sources_1/bd/nexys_shell/ipshared/b2d0/hdl/verilog" \
       +incdir+"../../../../PCore_FPGA.srcs/sources_1/bd/nexys_shell/ipshared/1ddd/hdl/verilog" \
       +incdir+"../../../../PCore_FPGA.srcs/sources_1/bd/nexys_shell/ipshared/b2d0/hdl/verilog" \
       +incdir+"/home/mtahir/Xilinx/Vivado/2019.1/data/xilinx_vip/include"
}
