...
#
# Generated by Vivado on Wed Jul 26 13:30:11 PKT 2023
...
# Script info
echo -e "nexys_shell.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
{
  file="xsim.ini"
  lib_map_path="/home/uetlhr/Xilinx/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
